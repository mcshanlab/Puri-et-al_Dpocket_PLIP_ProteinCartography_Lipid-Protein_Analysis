...
prop_col_keyword = "hydrophobicity_score"  # column to plot
output_pdf = "hydrophobicity_score_violin.pdf"
median_output_txt = "hydrophobicity_score_median_values.txt"
...
for sheet in target_sheets:
    ...
    # auto-find hydrophobicity_score column
    prop_col = None
...
with open(median_output_txt, "w") as f:
    f.write(f"Lipid class\tMedian {prop_col_keyword}\n")
...
plt.ylabel("Hydrophobicity score", fontsize=11)
