...
prop_col_keyword = "lig_vol"  # NEW — lipid volume column
output_pdf = "lipid_volume_violin.pdf"
median_output_txt = "lipid_volume_median_values.txt"
...
# --------------------------------------
violin_output_file = "lipid_volume_violin_values.tsv"

with open(violin_output_file, "w") as f:
    f.write("class\tlig_vol\n")
...
with open(median_output_txt, "w") as f:
    f.write(f"Lipid class\tMedian lipid volume (Å³)\n")
...
plt.ylabel("Lipid volume (Å³)", fontsize=11)
