...
prop_col_keyword = "as_max_dst"  # NEW — lipid volume column
output_pdf = "as_max_dst_violin.pdf"
median_output_txt = "as_max_dst_median_values.txt"
...
# --------------------------------------
violin_output_file = "as_max_dst_violin_values.tsv"

with open(violin_output_file, "w") as f:
    f.write("class\tas_max_dst\n")
...
plt.ylabel("as_max_dst", fontsize=11)
