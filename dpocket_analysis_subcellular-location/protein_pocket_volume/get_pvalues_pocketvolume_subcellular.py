...
# --------------------------------------
input_files = glob.glob("pocket_volume_*_GO_CC_values.tsv")

output_file = "pocket_volume_GO_within_lipid_significance.tsv"
...
for file in input_files:
    ...
    df = df.dropna(subset=["pock_vol", "GO_CC", "class"])
    ...
    for a, b in itertools.combinations(go_groups, 2):
        ...
        group_a = df[df["GO_CC"] == a]["pock_vol"]
        group_b = df[df["GO_CC"] == b]["pock_vol"]
