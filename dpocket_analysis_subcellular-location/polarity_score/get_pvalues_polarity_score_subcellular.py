...
# --------------------------------------
input_files = glob.glob("polarity_score_*_GO_CC_values.tsv")

output_file = "polarity_score_GO_within_lipid_significance.tsv"
...
for file in input_files:
    ...
    df = df.dropna(subset=["polarity_score", "GO_CC", "class"])
    ...
    for a, b in itertools.combinations(go_groups, 2):
        ...
        group_a = df[df["GO_CC"] == a]["polarity_score"]
        group_b = df[df["GO_CC"] == b]["polarity_score"]
