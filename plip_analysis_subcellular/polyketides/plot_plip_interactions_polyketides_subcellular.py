...
with open(
    "polyketides_high_interaction_contributors_by_subcellular_location.txt",
    "w"
) as f:
    f.write("\n".join(out_lines))
...
ax.set_title(
    "Polyketides–Protein Interaction Profiles by Subcellular Location"
)
...
# -----------------------------
plt.savefig(
    "polyketides_interaction_profiles_by_subcellular_location.pdf",
    format="pdf",
    bbox_inches="tight"
)
