...
# -----------------------------
df = pd.read_csv("sphingolipids_plip_interaction_counts.tsv", sep="\t")
...
with open(
    "sphingolipids_high_interaction_contributors_by_subcellular_location.txt",
    "w"
) as f:
    f.write("\n".join(out_lines))
...
ax.set_title(
    "Sphingolipids–Protein Interaction Profiles by Subcellular Location"
)
...
# -----------------------------
plt.savefig(
    "sphingolipids_interaction_profiles_by_subcellular_location.pdf",
    format="pdf",
    bbox_inches="tight"
)
