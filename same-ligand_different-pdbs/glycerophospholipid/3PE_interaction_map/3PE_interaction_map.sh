...
# Config
# ----------------------------------------
root_dir="/Volumes/GigiMurin/plip/Glycerophospholipid"
output_file="3PE_lipid_atoms_total_clean.txt"
...
echo "Consolidated 3PE atom counts saved in: $output_file"
