...
# Config
# -----------------------------
data_file = "REA_lipid_atoms_total_clean.txt"
output_file = "REA_atom_interactions_percentage.pdf"
...
# Sort descending so hottREA atoms appear first
...
plt.title("Percentage of Interactions per REA Atom")
