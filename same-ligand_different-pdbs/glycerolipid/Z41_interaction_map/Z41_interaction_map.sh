...
# Config
# ----------------------------------------
root_dir="/Volumes/GigiMurin/plip/Gylcerolipids"
output_file="Z41_lipid_atoms_total_clean.txt"
...
echo "Consolidated Z41 atom counts saved in: $output_file"
