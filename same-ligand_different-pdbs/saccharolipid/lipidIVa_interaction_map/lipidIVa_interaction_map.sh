...
# Config
# ----------------------------------------
root_dir="/Volumes/GigiMurin/plip/saccharo_lipid"
output_file="LP5_lipid_atoms_total_clean.txt"
...
echo "Consolidated LP5 atom counts saved in: $output_file"
