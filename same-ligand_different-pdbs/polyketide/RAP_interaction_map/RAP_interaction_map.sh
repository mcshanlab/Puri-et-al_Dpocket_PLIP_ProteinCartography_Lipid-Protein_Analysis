...
# Config
# ----------------------------------------
root_dir="/Volumes/GigiMurin/plip/polyketide"
output_file="RAP_lipid_atoms_total_clean.txt"
...
echo "Consolidated RAP atom counts saved in: $output_file"
