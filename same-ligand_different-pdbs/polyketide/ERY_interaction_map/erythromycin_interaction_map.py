...
# Config
# -----------------------------
data_file = "ERY_lipid_atoms_total_clean.txt"
output_file = "ERY_atom_interactions_percentage.pdf"
...
# Sort descending so hottERY atoms appear first
...
plt.title("Percentage of Interactions per ERY Atom")
