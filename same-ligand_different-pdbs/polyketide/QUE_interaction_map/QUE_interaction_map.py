...
# Config
# -----------------------------
data_file = "QUE_lipid_atoms_total_clean.txt"
output_file = "QUE_atom_interactions_percentage.pdf"
...
# Sort descending so hottQUE atoms appear first
...
plt.title("Percentage of Interactions per QUE Atom")
