...
# Config
# -----------------------------
data_file = "RAP_lipid_atoms_total_clean.txt"
output_file = "RAP_atom_interactions_percentage.pdf"
...
# Sort descending so hottRAP atoms appear first
...
plt.title("Percentage of Interactions per RAP Atom")
