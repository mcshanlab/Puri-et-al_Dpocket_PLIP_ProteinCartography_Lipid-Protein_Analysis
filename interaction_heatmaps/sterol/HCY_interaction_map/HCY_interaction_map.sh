...
# Config
# ----------------------------------------
root_dir="/Volumes/GigiMurin/plip/sterol_lipids"
output_file="HCY_lipid_atoms_total_clean.txt"
...
echo "Consolidated HCY atom counts saved in: $output_file"
