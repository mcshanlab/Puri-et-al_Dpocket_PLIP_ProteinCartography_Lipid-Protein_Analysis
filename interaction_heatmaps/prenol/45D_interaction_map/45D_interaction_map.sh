...
# Config
# ----------------------------------------
root_dir="/Volumes/GigiMurin/plip/prenol_lipid"
output_file="45D_lipid_atoms_total_clean.txt"
...
echo "Consolidated 45D atom counts saved in: $output_file"
