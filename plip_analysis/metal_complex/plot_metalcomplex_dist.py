...
# --------------------------------------
base_dir = Path(".")
output_pdf = "metalcomplex_distance_violin.pdf"
median_output_txt = "metalcomplex_distance_medians.txt"
...
# --------------------------------------
violin_output_file = "metalcomplex_dist_violin_values.tsv"

with open(violin_output_file, "w") as f:
    f.write("class\tmetalcomplex_dist\n")
...
plt.ylabel("Metal Complex Distance (Å)", fontsize=11)
