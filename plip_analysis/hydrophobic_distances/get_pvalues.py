...
# --------------------------------------
# Input file (hydrophobic distances)
# --------------------------------------
input_file = "hydrophobic_distances_violin_values.tsv"
output_file = "hydrophobic_distances_pairwise_significance.tsv"

value_col = "hydrophobic_distance"
